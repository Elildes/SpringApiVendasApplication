...
import com.elildes.vendas.SpringApiVendasApp;
import com.elildes.vendas.config.AsyncSyncConfiguration;
import com.elildes.vendas.config.EmbeddedSQL;
...
@SpringBootTest(classes = { SpringApiVendasApp.class, AsyncSyncConfiguration.class })
@EmbeddedSQL
